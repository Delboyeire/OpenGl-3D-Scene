...
public:
    ...
    Camera():forwardSpeed(0.5f),roationSpeed(0.3f){}
    ...
    void ViewingTransform(){
        ...
        gluLookAt(	position.x,position.y,position.z,// camera position
					center.x,center.y,center.z, //look at this point //TODO: BUG here!! what is it ??
